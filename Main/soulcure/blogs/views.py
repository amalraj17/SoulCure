...
def add_blog(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('editor')  # Redirect to home page after successfully adding the post
    else:
        cat = BlogCategory.objects.all()
...
def single_view_editor(request, post_id):
    ...
    return render(request, 'editor/singleview.html', {'post': post})
...
def edit_blog(request,post_id):
    ...
    return render(request, 'editor/edit-blog.html',{'post':post})
